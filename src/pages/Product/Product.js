        		...
        		<Header/>
	        		<div className = {style.bigbg}>
	        			<div className = {style.goodsheader}>
	        				<img className = {style.titlePic} src = {require('./img/pdpic.png')} />
	        				<div className = {style.goodsword}>
	        					<h3>1T算力720天合约（含电费）</h3>
	        					<dl>
	        						<dt>售价：<p className = {style.price}>¥16000</p></dt>
	        						<dt>销量：<p>186</p>  人气：<p>198</p></dt>
	        					</dl>
        						<ul>
        							<li>
        								<h4>租赁数量</h4>
        								<p className = {style.addndecre}><input className = {style.btn} type = "button" value = "-"/><input className = {style.nums} value = '1'/><input className = {style.btn} type = "button" value = "+" /></p>
        							</li>
        							<li>
        								<h4>租赁时间</h4>
        								<input type= 'input' value = '90天' />
        							</li>
        						</ul>
